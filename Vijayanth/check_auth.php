...
ob_start(function ($html) use ($signedPlantIdJson, $signedRoleJson, $signedConfigJson, $currentPage) {
    ...
    if ($currentPage === 'overview.php') {
        ...
        $injection .= "\n<link rel=\"stylesheet\" href=\"assets/overview_compact_headers.css?v=20260721-1\">";
        $injection .= "\n<script src=\"assets/inverter3_fix.js?v=20260721-4\"></script>";
        $injection .= "\n<script src=\"assets/overview_ui_runtime_fix.js?v=20260721-7\"></script>";
        $injection .= "\n<script src=\"assets/overview_week_generation.js?v=20260721-2\"></script>";
        $injection .= "\n<script src=\"assets/overview_force_plant_info_position.js?v=20260721-2\"></script>";
    }
